...
const contactLinks = [
  ...
  {
    label: "LinkedIn",
    value: "linkedin.com/in/chethan-yallampalli-b82681236",
    href: "https://www.linkedin.com/in/chethan-yallampalli-b82681236",
    icon: Linkedin
  },
  {
    label: "GitHub",
    value: "github.com/chethan1n1",
    href: "https://github.com/chethan1n1",
    icon: Github
  },
  {
    label: "Portfolio",
    value: "chethanyallampalli.site",
    href: "https://www.chethanyallampalli.site",
    icon: Globe
  }
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-16 pt-8 border-t border-gray-200">
          <p className="text-gray-600 font-light">
            © 2024 Chethan Yallampalli. Built with passion for technology and innovation.
          </p>
        </div>
      </div>
    </section>
