...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children} {" "}
    <ChevronDown
      className="relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180 group-hover:scale-125 group-hover:text-amber-500 group-data-[active]:scale-125 group-data-[active]:text-[#007AFF]"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
